    ...
    >
      <div className={styles.stack}>
        <div
          ...
          aria-label={
            readOnly
              ? 'Audio waveform. Read-only annotation. Use Space to play and arrow keys to seek.'
              : 'Audio waveform. Drag empty space to create a region. Use Space to play, arrow keys to seek, and Add region for keyboard annotation.'
          }
        />
